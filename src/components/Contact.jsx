    ...
    <>
      <div className="xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden">
        <motion.div
          ...
          className="relative flex-[0.75] p-8 rounded-2xl"
          ...
          >
            <label className="flex flex-col">
              ...
              <input
                ...
                className="py-4 px-6 text-white placeholder:text-secondary rounded-lg outline-none border-none font-medium"
              />
            </label>
            ...
            <button
              type="submit"
              className="py-3 px-8 rounded-xl outline-none text-white font-bold w-fit shadow-md shadow-primary"
            >
